...
const PAGES: Page[] = [
  ...
  { label: "Community", href: "/community", icon: MessagesSquare, keywords: "forum posts discussion ask question help" },
  { label: "Groups", href: "/community/groups", icon: MessagesSquare, keywords: "community study group join" },
