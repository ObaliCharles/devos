...
function Item({ q, number }: { q: Question; number?: number }) {
  ...
  return (
    <div>
        ...
        {q.choices.map((choice, ci) => {
          ...
          return (
            <button
              ...
              className="flex items-center gap-2.5 rounded-[var(--radius-tile)] border px-3.5 py-2.5 text-left text-ui transition-colors"
      ...
      {answered && (
        <p className="mt-2 text-micro font-medium" style={{ color: correct ? "var(--success)" : "var(--danger)" }}>
