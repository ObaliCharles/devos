        ...
        {STEPS.map((label, i) => (
          <li key={label} className="flex items-center gap-2">
            <button
              ...
              disabled={i > step}
              className="flex items-center gap-2 rounded-full px-3 py-1.5 text-ui transition-colors disabled:cursor-default"
              style={{
            ...
            >
              <span
                className="grid h-5 w-5 place-items-center rounded-full text-micro tabular-nums"
                style={{
